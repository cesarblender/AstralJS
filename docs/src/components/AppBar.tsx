    ...
    <div>
      <div className="w-full h-16 bg-gray-950 fixed backdrop-blur-sm bg-opacity-60 top-0 flex items-center px-2">
        <div className="container mx-auto flex items-center justify-between">
          <h2 className="font-bold md:text-2xl text-lg text-fuchsia-100 flex items-center gap-1">
          ...
          <a
            ...
            target="_blank"
            className="bg-fuchsia-200 lg:text-lg text-sm text-black font-semibold rounded-lg p-2"
          >
            AstralJS Wiki
          </a>
        </div>
